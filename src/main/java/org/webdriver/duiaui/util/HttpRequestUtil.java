...
public class HttpRequestUtil {
    public Result doPost(String host,String url,String bodyJsonParams,Map<String, String> headerParams){
        ...
        jodd.http.HttpRequest httpRequest= new jodd.http.HttpRequest().post(host+url);
    ...
    public  Result doGet(String host,String url,Map<String,String>param)
    {
        ...
        long endTime=0;
        startTime=System.currentTimeMillis();
        HttpResponse httpResponse= jodd.http.HttpRequest.get(host+url).query(param).send();
        String statusCode="";
        String responseText="";
        String responseHeader="";
        String requestHeader="";
