...
public class RegexUtils {
        ...
        public static void main(String[] args) {
            ...
            System.out.println((new RegexUtils()).getSubUtil(str,rgex));
            List<String> lists = (new RegexUtils()).getSubUtil(str,rgex);
            for (String string : lists) {
                System.out.println(string);
            }
            System.out.println((new RegexUtils()).getSubUtilSimple(str, rgex));
        }
