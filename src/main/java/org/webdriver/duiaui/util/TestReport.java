...
import org.webdriver.duiaui.config.Config;
...
public class TestReport implements IReporter{
	...
	private void outputResult(List<ITestResult> fullResults, String path){
		...
		try {
			...
			sb.append("<div id=\"logo\"><img src=\"logo.png\"></img></div>\n");
			...
			sb.append("</div>\n"
					...
					+ "<div id=\"footer\" >技术支持：Copyright © 2018 对啊网测试框架.Inc</div>");
			sb.append("</body>\n</html>\n");
			...
			sb2.append("<div id=\"logo\" ><img src=\"D:\\front\\testoutput\\logo1.png\" style=\"margin:0px auto\"></img></div>\n");
          ...
          /* sb2.append("</table>\n");*/
			...
			sb2.append("</table>\n</div>\n");
			sb2.append("</div>\n"
					+ "<div id=\"footer\" style=\"font-size:14px\" >技术支持：Copyright © 2018 AHS自动化框架.Inc</div>");
			sb2.append("</body>\n</html>\n");
			System.out.println("收件人地址："+Recipients);
